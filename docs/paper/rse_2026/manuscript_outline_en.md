...
Define a single weighted objective comprising valid-pixel reconstruction, an OSM-derived merged
land-cover target stored under the legacy `worldcover` key, fine OSM semantic probes, hard-negative
terms, and within-rank uniformity. The registered V5 recipe gives weights 0.80, 0.25, 0.45, 0.90,
0.35, and 0.45 to Sentinel-2, Sentinel-1, Landsat, higher-resolution optical, higher-resolution
SAR, and the merged OSM land-cover target. The fine OSM semantic-probe weight ramps to 0.14 and the
uniformity weight ramps to 0.06. Input
