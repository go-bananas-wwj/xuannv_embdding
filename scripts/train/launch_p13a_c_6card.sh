...
INIT_FROM="${INIT_FROM:-/data/xuannv_embedding/outputs/v2_p12c_context160_semantic_rich_haidian_202512_202605_20260707/best.pt}"
LOG_ROOT="${LOG_ROOT:-/data/xuannv_embedding/logs/p13a_c_20260708}"
SESSION="${SESSION:-xuannv_p13a_c_6card}"
...
echo "  log=${LOG_ROOT}/p13a_c_6card.log"
