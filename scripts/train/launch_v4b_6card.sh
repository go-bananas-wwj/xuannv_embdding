...
CONFIG="${CONFIG:-configs/v4b_distill_decay_proto_haidian_harbin_202512_202605_20260712.yaml}"
LOG_ROOT="${LOG_ROOT:-/data/xuannv_embedding/logs/v4b_20260712}"
SESSION="${SESSION:-xuannv_v4b_6card}"
